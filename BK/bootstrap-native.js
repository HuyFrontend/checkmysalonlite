...
(function(factory){
  ...
  //MODAL DEFINITION
    ...
    this.options.containElement = options.containElement;
    ...
    if ( this.options.content && this.options.content !== undefined ) {
      ...
      this.content( this.options.content , this.options.containElement);
    }
    this.dismiss();
    this.keydown();
    this.trigger();
    ...
    // }
    Modal.prototype.content = function( content, containElement) {
      return this.modal.querySelector('[' + containElement+ ']').innerHTML = content;
    }
