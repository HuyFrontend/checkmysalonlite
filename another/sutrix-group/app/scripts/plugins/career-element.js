    ...
    actions : function() {
      ...
      self.getSuccess = function (data) {
        ...
        if(opt.elementDetail) {
          ...
          // if(detailBlock.classList) {
          //   detailBlock.classList.remove(opt.classHidden);
          //   detailBlock.fadeInFadeOut('in', 1000);
          // }
          // if(applyBlock && applyBlock.classList) {
          //   applyBlock.classList.add(opt.classHidden);
          // }
          // else {
          //   applyBlock.addClass(opt.classHidden);
          //   applyBlock.fadeInFadeOut('out', 1000);
          // }
        }
      };
      ...
      self.hideAndShow = function (elementHide, showElement) {
        if(showElement.classList) {

            showElement.fadeInFadeOut('in', 500);
            elementHide.fadeInFadeOut('out', 500);
          // }
          // if(elementHide && elementHide.classList) {
          //   // elementHide.classList.add(opt.classHidden);
          // }
          // else {
          //   // elementHide.fadeInFadeOut('out', 3000);
          //   setTimeout(function () {
          //     // elementHide.addClass(opt.classHidden);
          //     // showElement.classList.remove(opt.classHidden);
          //   }, 500);
          }
      };
    }
